                    ...
                    <div class="d-flex order-lg-2">
                                ...
                                <div class="header-dropdown-list message-menu">
                                    <div class="dropdown-item d-flex p-4">
                                        ...
                                        <span
                                            ...
                                            data-bs-image-src="{{ asset('admin-assets/sash/assets/images/pngs/4.jpg') }}"></span>
                                        <div class="wd-50p">
                                    ...
                                    <div class="dropdown-item d-flex p-4">
                                        ...
                                        <span
                                            class="avatar avatar-xl br-5 me-3 align-self-center cover-image"
                                            data-bs-image-src="{{ asset('admin-assets/sash/assets/images/pngs/6.jpg') }}"></span>
                                        <div class="wd-50p">
                                    ...
                                    <div class="dropdown-item d-flex p-4">
                                        ...
                                        <span
                                            class="avatar avatar-xl br-5 me-3 align-self-center cover-image"
                                            data-bs-image-src="{{ asset('admin-assets/sash/assets/images/pngs/8.jpg') }}"></span>
                                        <div class="wd-50p">
                                    ...
                                    <div class="dropdown-item d-flex p-4">
                                        ...
                                        <span
                                            class="avatar avatar-xl br-5 me-3 align-self-center cover-image"
                                            data-bs-image-src="{{ asset('admin-assets/sash/assets/images/pngs/1.jpg') }}"></span>
                                        <div class="wd-50p">
                                    ...
                                    <div class="dropdown-item d-flex p-4">
                                        ...
                                        <span
                                            class="avatar avatar-xl br-5 me-3 align-self-center cover-image"
                                            data-bs-image-src="{{ asset('admin-assets/sash/assets/images/pngs/3.jpg') }}"></span>
                                        <div class="wd-50p">
                                ...
                                <div class="message-menu message-menu-scroll">
                                    <a class="dropdown-item d-flex" href="chat.html">
                                        <span
                                            ...
                                            data-bs-image-src="{{ asset('admin-assets/sash/assets/images/users/1.jpg') }}"></span>
                                        <div class="wd-90p">
                                            <div class="d-flex">
                                    ...
                                    <a class="dropdown-item d-flex" href="chat.html">
                                        <span
                                            class="avatar avatar-md brround me-3 align-self-center cover-image"
                                            data-bs-image-src="{{ asset('admin-assets/sash/assets/images/users/15.jpg') }}"></span>
                                        <div class="wd-90p">
                                            <div class="d-flex">
                                    ...
                                    <a class="dropdown-item d-flex" href="chat.html">
                                        <span
                                            class="avatar avatar-md brround me-3 align-self-center cover-image"
                                            data-bs-image-src="{{ asset('admin-assets/assets/images/users/12.jpg') }}"></span>
                                        <div class="wd-90p">
                                            <div class="d-flex">
                                    ...
                                    <a class="dropdown-item d-flex" href="chat.html">
                                        <span
                                            class="avatar avatar-md brround me-3 align-self-center cover-image"
                                            data-bs-image-src="{{ asset('admin-assets/assets/images/users/4.jpg') }}"></span>
                                        <div class="wd-90p">
                                            <div class="d-flex">
                                    ...
                                    <a class="dropdown-item d-flex" href="chat.html">
                                        <span
                                            class="avatar avatar-md brround me-3 align-self-center cover-image"
                                            data-bs-image-src="{{ asset('admin-assets/assets/images/users/3.jpg') }}"></span>
                                        <div class="wd-90p">
                                            <div class="d-flex">
                        ...
                        <div class="dropdown d-flex profile-1">
                            <a href="javascript:void(0)" data-bs-toggle="dropdown" class="nav-link leading-none d-flex">
                                <img src="{{ asset('admin-assets/sash/assets/images/users/21.jpg') }}" alt="profile-user"
